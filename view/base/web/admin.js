...
(function () {
  ...
  var Client$1 = /*#__PURE__*/function () {
    function Client(config) {
      ...
      this.config = _objectSpread$8(_objectSpread$8({}, defaults$2), config);
      this.config.header = _objectSpread$8(_objectSpread$8({}, defaults$2.header), config.header && config.header);
    }
    /**
  ...
  function createInstance(defaultConfig) {
    ...
    var instance = bind$3(Axios_1.prototype.request, context); // Copy axios.prototype to instance
  ...
  var populateAddress = function populateAddress(options) {
    ...
    var address = _objectSpread$5({}, options.address);
  ...
  ***************************************************************************** */
    ...
    var machine = s({
      ...
      states: {
        ...
        notifying: {
          ...
          on: _objectSpread$4(_objectSpread$4(_objectSpread$4(_objectSpread$4({}, CLOSE), SUGGEST), NOTIFY), INPUT)
        },
        suggesting: {
          entry: ["renderSuggestions", "gotoCurrent", "expand"],
          exit: ["resetCurrent", "gotoCurrent", "contract"],
          on: _objectSpread$4(_objectSpread$4(_objectSpread$4(_objectSpread$4(_objectSpread$4({}, CLOSE), SUGGEST), NOTIFY), INPUT), {}, {
            NEXT: {
  ...
  var Controller = /*#__PURE__*/function () {
    function Controller(options) {
      ...
      if (this.options.autocomplete === true) this.options.autocomplete = defaults.autocomplete; // Scope the operations of this controller to a document or DOM subtree
    ...
    selectorList.forEach(function (selectors) {
      setupAutocomplete(config, selectors, {
        ...
        getScope: function getScope(anchor) {
          return getParent$1(anchor, parentScope$1);
        }
      });
    });
  };
  ...
  window.idpcStart = function () {
    return [bind$2, bind, bind$1].forEach(function (bind) {
      var conf = config();
      if (conf) bind(conf);
    });
  };
