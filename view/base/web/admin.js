...
(function () {
  ...
  var config = function config() {
    ...
    return _objectSpread$9(_objectSpread$9({}, defaults$c), c);
  };
  ...
  var Client$1 = /*#__PURE__*/function () {
    function Client(config) {
      ...
      this.config = _objectSpread$8(_objectSpread$8({}, defaults$b), config);
      this.config.header = _objectSpread$8(_objectSpread$8({}, defaults$b.header), config.header && config.header);
    }
    /**
  ...
  var isArray$2 = function isArray(i) {
  ...
  var reduceStringMap = function reduceStringMap(value) {
    ...
    if (isArray$2(value)) {
      value.forEach(function (val) {
        if (isNumber$2(val)) result.push(val.toString());
        if (isString$3(val)) result.push(val);
      });
      return result.join(",");
    }

    if (isNumber$2(value)) return value.toString();
  ...
  var toTimeout = function toTimeout(_ref, client) {
    ...
    if (isNumber$2(timeout)) return timeout;
  ...
  var toHeader$1 = function toHeader(_ref2, client) {
    ...
    return _objectSpread$7(_objectSpread$7({}, client.config.header), toStringMap(header));
  };
  ...
  var xhr$1 = function xhrAdapter(config) {
    return new Promise(function dispatchXhrRequest(resolve, reject) {
      ...
      request.ontimeout = function handleTimeout() {
        ...
        var transitional = config.transitional || defaults$a.transitional;
  ...
  var defaults$9 = {
    ...
    transformResponse: [function transformResponse(data) {
      var transitional = this.transitional || defaults$9.transitional;
  ...
  utils$j.forEach(['post', 'put', 'patch'], function forEachMethodWithData(method) {
    defaults$9.headers[method] = utils$j.merge(DEFAULT_CONTENT_TYPE$1);
  });
  var defaults_1$1 = defaults$9;
  ...
  var axios$3 = createInstance$1(defaults$6); // Expose Axios class to allow class inheritance

  axios$3.Axios = Axios$2; // Expose Cancel & CancelToken

  axios$3.Cancel = Cancel_1$1;
  axios$3.CancelToken = CancelToken_1$1;
  axios$3.isCancel = isCancel$3;
  axios$3.VERSION = data$1.version; // Expose all/spread

  axios$3.all = function all(promises) {
    return Promise.all(promises);
  };

  axios$3.spread = spread$1; // Expose isAxiosError

  axios$3.isAxiosError = isAxiosError$1;
  axios$4.exports = axios$3; // Allow use of default import syntax in TypeScript
  ...
  var Client = /*#__PURE__*/function (_CoreInterface) {
    ...
    function Client(config) {
      ...
      var agent = new Agent();
      return _super.call(this, _objectSpread$6({
        agent: agent
      }, config));
    }
  ...
  var getScope = function getScope(scope) {
    if (isString$1(scope)) return d$1().querySelector(scope);
  ...
  ***************************************************************************** */
    ...
    var machine = s({
      ...
      states: {
        ...
        notifying: {
          ...
          on: _objectSpread$3(_objectSpread$3(_objectSpread$3(_objectSpread$3(_objectSpread$3({}, CLOSE), SUGGEST), NOTIFY), INPUT), CHANGE_COUNTRY)
        },
        suggesting_country: {
          entry: ["renderContexts", "gotoCurrent", "expand", "addCountryHint"],
          exit: ["resetCurrent", "gotoCurrent", "contract", "clearHint"],
          on: _objectSpread$3(_objectSpread$3(_objectSpread$3(_objectSpread$3(_objectSpread$3(_objectSpread$3({}, CLOSE), NOTIFY), NEXT), PREVIOUS), RESET), {}, {
            INPUT: {
        ...
        suggesting: {
          ...
          exit: ["resetCurrent", "gotoCurrent", "contract", "clearHint"],
          on: _objectSpread$3(_objectSpread$3(_objectSpread$3(_objectSpread$3(_objectSpread$3(_objectSpread$3(_objectSpread$3(_objectSpread$3(_objectSpread$3({}, CLOSE), SUGGEST), NOTIFY), INPUT), CHANGE_COUNTRY), NEXT), PREVIOUS), RESET), {}, {
            SELECT_ADDRESS: {
              target: "closed",
  ...
  var defaults$5 = {
    ...
    onInput: NOOP$1,
    onLoaded: NOOP$1,
    onSearchError: NOOP$1,
    onSuggestionError: NOOP$1,
    onMounted: NOOP$1,
    onRemove: NOOP$1,
    onSuggestionsRetrieved: NOOP$1,
    onAddressSelected: NOOP$1,
    onAddressRetrieved: NOOP$1,
    onAddressPopulated: NOOP$1,
    onFailedCheck: NOOP$1,
    onMouseDown: NOOP$1,
    onKeyDown: NOOP$1,
    onUnhide: NOOP$1,
    onCountrySelected: NOOP$1
  };
  /**
   * # Controller
   *
  ...
  var Controller = /*#__PURE__*/function () {
    function Controller(options) {
      ...
      }), defaults$5), options); // Default inputField to line_1 if `inputField` not specified
      ...
      if (this.options.autocomplete === true) this.options.autocomplete = defaults$5.autocomplete; // Scope the operations of this controller to a document or DOM subtree
      ...
      if (isString$1(this.options.inputField)) {
    ...
    _createClass(Controller, [{
      ...
      value: function hiddenFields() {
        ...
        return this.options.hide.map(function (e) {
          if (isString$1(e)) return toHtmlElem(_this7.options.scope, e);
          return e;
        }).filter(function (e) {
          return e !== null;
        });
    ...
    selectorList.forEach(function (selectors) {
      setupAutocomplete(config, selectors, {
        ...
        getScope: function getScope(anchor) {
          return getParent$1(anchor, parentScope$2);
        }
      });
    });
  };
  ...
  var bind$1 = function bind(config) {
    setupAutocomplete(config, selectors, {
      pageTest: pageTest$1,
      getScope: function getScope(anchor) {
        return getParent$1(anchor, parentScope$1, parentTest$1);
      }
    });
  };
