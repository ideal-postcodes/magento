...
class StoreConfig implements ArgumentInterface
{
    ...
    /**
     * Get full configuration as JSON string for x-magento-init
     *
     * @return string
     */
    public function getJsonConfig(): string
    {
        ...
        return $this->jsonSerializer->serialize([
            ...
            'postcodeLookup' => (bool)($config['postcodeLookup'] ?? false),
            ...
            'hoistCountry' => (bool)($config['hoistCountryField'] ?? false),
            'autocompleteOverride' => $this->parseJsonConfig($config['autocompleteOverride'] ?? null),
            'postcodeLookupOverride' => $this->parseJsonConfig($config['postcodeLookupOverride'] ?? null),
